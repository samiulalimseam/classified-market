  ...
  return (
    <div className='hover:shadow-xl  rounded-xl duration-500 shadow mx-2 w-96 md:w-56 m-auto my-2   p-2'>
      <div className="carousel-item w-96 md:w-56 tohover ">
        <img className='md:w-52 w-96 hover:scale-105 duration-500' src={product.img} alt="" />
      </div>
      <div className='flex flex-col justify-around items-start'>
        ...
        <div className="flex justify-between w-full items-center"><p className='font-thin text-sm'>Posted by: {product.seller} </p> <img className='w-5 border border-primary rounded-full' src={product.sellerImg} alt="" /> </div>
        ...
        <div className="flex justify-start items-center"><p className='text-sm text-accent mr-1'><BsPinMapFill></BsPinMapFill></p> <p className='font-thin text-sm '>
